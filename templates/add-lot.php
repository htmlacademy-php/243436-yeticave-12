<main>
    ...
    <form class="form form--add-lot container <?= !empty($errors) ? 'form--invalid' : ''; ?>" action="add.php"
        ...
        <div class="form__container-three">
            <div
                class="form__item form__item--small  <?= $errors['lot-rate'] || validate_price('lot-rate') === 'form__item--invalid' ? 'form__item--invalid' : ''; ?>">
            ...
            <div
                class="form__item form__item--small <?= $errors['lot-step'] || validate_price('lot-step') === 'form__item--invalid' ? 'form__item--invalid' : ''; ?>">
