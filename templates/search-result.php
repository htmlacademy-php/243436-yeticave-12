                            ...
                            <div class="lot__info">
                                ...
                                <div class="lot__state">
                                    ...
                                    <div class="lot__timer timer <?php [
                                        $hours,
                                        $minutes
                                    ] = get_dt_range($value['date_finish']);
        ...
        <?php if ((int)$pages_count > 1) : ?>
            <ul class="pagination-list">
                <li class="pagination-item pagination-item-prev"><a
                        href="/search.php?search=<?= $search; ?>&find=Найти&page=<?php if ((int)$cur_page > 1) {
                ...
                <li class="pagination-item pagination-item-next"><a
                        href="/search.php?search=<?= $search; ?>&find=Найти&page=<?php if ((int)$cur_page < (int)$pages_count) {
                            echo (int)++$cur_page;
                        } else {
